...
export default class RoadSignConceptModel extends ConceptModel {
  ...
  @hasMany('road-sign-concept', { inverse: 'relatedFromRoadSignConcepts' })
  relatedToRoadSignConcepts;
  @hasMany('road-sign-concept', { inverse: 'relatedToRoadSignConcepts' })
  relatedFromRoadSignConcepts;
  @hasMany('road-marking-concept', { inverse: 'relatedRoadSignConcepts' })
  relatedRoadMarkingConcepts;
  @hasMany('traffic-light-concept', { inverse: 'relatedRoadSignConcepts' })
